...
class SummaryDiaryCoreDataHandler: NSObject {
    ...
    class func saveObject(summary: Summary){
        ...
        manageObject.setValue(summary.sugar, forKey: "sugar")
